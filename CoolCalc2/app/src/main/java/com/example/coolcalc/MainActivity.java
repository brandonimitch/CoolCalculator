...
public class MainActivity extends Activity {
    ...
    // Tracks the numbers pressed and concatenates each new one to the end
    void numberPressed( int number ) {
        runningNumber += String.valueOf( number );      // Concatenate input from user
        resultsView.setText(runningNumber);             // Display the input on the app
    }
}
